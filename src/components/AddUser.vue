  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7 add-user">
        ...
        <RouterLink to="/" class="add-user_button" @click="addUser">Update Details</RouterLink>
      </div>
      <div class="col-md-1"></div>
      <form class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3 avatar" runat="server">
        <img src="../assets/avatar.png" alt="" id="blah">
        <input @change="onFileChange(), onImageChange()" type="file" id="upload" hidden/>
        <label for="upload">
...
<script setup>
  ...
  function addUser() {
    fetchJSON(`https://reqres.in/api/users`, {
      method: 'POST',
      body: JSON.stringify({
